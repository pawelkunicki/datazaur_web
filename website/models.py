...
from markets.models import Exchange
...
class UserProfile(models.Model):
    ...
    currency = models.ForeignKey('forex.Currency', on_delete=models.CASCADE, related_name='myuser_currency', null=True,
                                 blank=True)
    portfolio = models.ForeignKey('portfolio.Portfolio', related_name='userprofile_portfolio', on_delete=models.CASCADE, null=True, blank=True)
    ...
    exchanges = models.ManyToManyField('markets.Exchange', related_name='userprofile_exchanges')
